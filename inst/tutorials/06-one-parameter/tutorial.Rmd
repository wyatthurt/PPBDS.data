...
```{r sd6, exercise = TRUE, message = FALSE, exercise.lines = 13}
sample_urn <- function(size, reps) {
  urn %>%
    rep_sample_n(size = size, reps = reps, replace = TRUE) %>%
    mutate(is_red = (color == "red"), is_white = (color == "white")) %>%
...
```{r sd9, exercise = TRUE, message = FALSE, exercise.lines = 13}
sample_urn <- function(size, reps) {
  urn %>%
    rep_sample_n(size = size, reps = reps, replace = TRUE) %>%
    mutate(is_red = (color == "red"), is_white = (color == "white")) %>%
...
```{r sd14, exercise = TRUE, message = FALSE, exercise.lines = 20}
sample_urn <- function(size, reps) {
  urn %>%
    rep_sample_n(size = size, reps = reps, replace = TRUE) %>%
    mutate(is_red = (color == "red"), is_white = (color == "white")) %>%
