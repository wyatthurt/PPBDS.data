...
Open response is a third type of question in tutorials. Type in the version of R that your computer is running. If your answer is not `4.0.1`, the question will tell you that you are incorrect and allow you to try again.
```{r question-1-4}

question_text(
    "What version of R is your computer running?",
    allow_retry = T,
    answer("4.0.1", correct = T)
  )
...
```{r question-1-6-hint, silent = TRUE}
options("pkgType")
```
