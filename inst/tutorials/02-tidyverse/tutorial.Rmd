...
```{r exercise-2-1, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-2, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-3, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-4, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-5, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-6, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-7, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-8, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-9, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-10, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-11, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-12, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-13, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-14, exercise = TRUE, exercise.setup = "stringr-objects"}
...
```{r exercise-2-15-setup, exercise.setup = "stringr-objects"}
states2 <- states2 %>%
...
```{r exercise-2-16-setup, exercise.setup = "stringr-objects"}
states2 <- states2 %>% 
  mutate(state = str_sub(state, 1, 2)) %>% 
...
```{r exercise-2-17-setup, exercise.setup = "stringr-objects"}
states2 <- states2 %>%
  mutate(state = str_sub(state, 1, 2)) %>% 
  mutate(state = str_to_upper(state)) %>%
...
```{r exercise-3-1, exercise = TRUE, exercise.setup = "cars"}
...
```{r exercise-3-2, exercise = TRUE, exercise.setup = "cars"}
...
```{r question-3-3, exercise = TRUE, exercise.setup = "cars"}
...
```{r question-3-4, exercise = TRUE, exercise.setup = "cars"}
...
```{r question-3-5, exercise = TRUE, exercise.setup = "cars"}
...
```{r question-3-6, exercise = TRUE, exercise.setup = "cars"}
...
```{r question-3-7-setup, exercise.setup = "cars"}
...
```{r question-3-8-setup, exercise.setup = "cars"}
lexus_1998 <- lexus_1998 %>%
  rename("class" = type)
...
```{r question-3-9-setup, exercise.setup = "cars"}
lexus_1998 <- lexus_1998 %>%
  rename("class" = type)
lexus_two_year <- bind_rows(lexus_1998, lexus_1999)
...
```{r question-3-9, exercise = TRUE, exercise.setup = "cars"}

```

```{r question-3-9-hint-1}
lexus %>%
  unite(..., ..., ..., sep = ...)
```

```{r question-3-9-hint-2}
lexus %>%
  unite("vehicle", ..., ..., sep = " ")
```
...
```{r question-3-11, exercise = TRUE, exercise.setup = "cars"}
...
```{r question-3-12, exercise = TRUE, exercise.setup = "cars"}
...
```{r question-3-13, exercise = TRUE, exercise.setup = "cars"}
...
```{r question-3-14, exercise = TRUE, exercise.setup = "cars"}
