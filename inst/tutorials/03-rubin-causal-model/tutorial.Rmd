...
question("Which of the following equations is incorrect?",
    ...
    answer("$Y_t(u) = Y_c(u) + \\tau$", correct = TRUE, message = "Nice!"),
    answer("$Y_c(u) - Y_t(u) = \\tau$"),
    allow_retry = TRUE
  )
)
...
<div id="question-2-1-hint">
**Hint:** Outcome when treated minus outcome when control equals the causal effect.
</div>

```{r question-2-1-hint, eval=FALSE}
...
question_text("In order to apply the causal effect of a sample to the general population, our samaple must be ______ of the population.",
    allow_retry = TRUE,
    answer("representative", correct = TRUE)
  ),
