...
<!-- We need tutorials about using Git, using the command line and other non-R stuff. Maybe make it a separate Tools tutorial? Could have lots of questions like: "Type this in at the Terminal command line and paste whatever comes back here:"-->

<!-- Can we show "answers" to a Tutorial after students have submitted it? How? -->

<!-- Can we give students a search box in the tutorial so that they can find answers to questions they have already done? -->

<!-- Any easy way to break tutorials into 2 or 3 subparts, so students aren't overwhelmed? -->
...
<!-- Code for processing a bunch of answers. -->
