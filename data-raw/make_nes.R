...
# education cleaning 
  ...
  # still trying to come to a satisfactory conclusion for 'hs diploma +'
  # what the + implies is a bit unclear at present, though likely will be combined with 'hs diploma'
